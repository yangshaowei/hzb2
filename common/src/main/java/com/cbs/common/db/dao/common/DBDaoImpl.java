 ...
 */
package com.cbs.common.db.dao.common;
...
import com.cbs.common.db.orm.TableHelper;
import com.cbs.common.db.orm.annotation.ActionType;
import com.cbs.common.db.orm.annotation.Column;
import com.cbs.common.db.orm.annotation.Id;
import com.cbs.common.db.orm.annotation.Relations;
import com.cbs.common.db.orm.annotation.RelationsType;
...
public class DBDaoImpl<T> extends BasicDBDao implements DBDao<T> {
	...
	public T queryOne(int id) {
		...
		Log.d(TAG, "[queryOne]: select * from " + this.tableName + " where "
				+ this.idColumn + " = '" + id + "'");
		List<T> list = queryList(null, selection, selectionArgs, null, null,
				null, null);
		lock.unlock();
	 ...
	 * @see DBDao#isExist(String, String[])
	 */
	@Override
	 ...
	 * @return the list
	 * @see DBDao#queryList(String[], String, String[], String, String, String, String)
	 */
	@Override
	public List<T> queryList(String[] columns, String selection,
			...
			Cursor cursor = null;
			try {
				Log.d(TAG, "[queryList] from "+this.tableName+" where "+selection+"("+Arrays.toString(selectionArgs)+")"+" group by "+groupBy+" having "+having+" order by "+orderBy+" limit "+limit);
     ...
     * @param selectionArgs the selection args
     * @return the list
     * @see DBDao#queryList(String, String[])
     * @author: amsoft.cn
     */
	@Override
	 ...
	 * @param flag the flag
	 * @return the long
	 * @see DBDao#insert(Object, boolean)
	 */
	@Override
	 ...
	 * @param flag the flag
	 * @return the long
	 * @see DBDao#insertList(List, boolean)
	 */
	@Override
	 ...
	 * @return the long
	 * @see DBDao#delete(String, String[])
	 */
	@Override
	 ...
	 * @param selectionArgs the selection args
	 * @return the list
	 * @see DBDao#queryMapList(String, String[])
	 */
	@Override
	 ...
	 * @param selectionArgs the selection args
	 * @return the int
	 * @see DBDao#queryCount(String, String[])
	 */
	@Override
	 ...
	 * @param sql the sql
	 * @param selectionArgs the selection args
	 * @see DBDao#execSql(String, Object[])
	 */
	@Override
